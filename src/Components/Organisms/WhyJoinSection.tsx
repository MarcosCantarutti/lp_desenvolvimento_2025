...
const WhyJoinSection: React.FC = () => {
  ...
  const resultadoItems: string[] = [
    ...
    "Sistema que possibilitam os melhores processos de RH de forma eficiente e mensurável.",
      ...
      <div className="relative container px-5 py-24 mx-auto space-y-20">
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          <p className="mt-4 text-gray-600">
            Conectamos estratégia, pessoas e execução para acelerar a evolução
            do seu negócio.
          </p>
        </div>
